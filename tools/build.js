...
const CFG = {
  name:      'Жол Тест',
  shortName: 'Жол Тест',
  descRu:    'Бесплатный тренажёр теоретического экзамена ПДД Республики Казахстан: 251 вопрос с разбором, схемы перекрёстков, дорожные знаки. Без рекламы и регистрации.',
  descKk:    'Қазақстан Республикасының ЖҚЕ теориялық емтиханына тегін дайындық: талдауымен 251 сұрақ, қиылыс сызбалары, жол белгілері.',
  lang:      'ru',
  themeDark: '#0A120E',
  themeLight:'#F2F0E9',
